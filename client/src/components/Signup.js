    ...
    return (
        <>
            ...
            <div className="container" style={{ paddingTop: "35px" }}>
                <form className="loginform" style={{ paddingTop: "15px" }} method="POST">
                    <h2 className="logintitle">SignUp</h2>
                    <input className="input" type="text" placeholder="Name" value={user.name} onChange={handleInputs} autoComplete="off" required name="name" />
                    ...
                    <input className="input" type="number" placeholder="Mobile Number" value={user.phone} onChange={handleInputs} autoComplete="off" required name="phone" />
                    ...
                    <div className="login-button">
                        <button className="btn btn-primary button" onClick={PostData}>Signup</button>
